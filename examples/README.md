...
|------|---------|---------|---------------|
| 1 | [`arraylang-roundtrip`](arraylang-roundtrip) | Tiny `ArrayLang` from the README | Exact round-trip + in-place `values.set(i, …)` keeping sibling whitespace (needs 0.2.1+) |
...
ArrayLang needs **0.2.1+** (in-place list-edit fix): publish this repo to
