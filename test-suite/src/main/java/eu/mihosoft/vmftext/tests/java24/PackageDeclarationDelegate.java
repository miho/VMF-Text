...
public class PackageDeclarationDelegate implements DelegatedBehavior<eu.mihosoft.vmftext.tests.java24.PackageDeclaration> {
    private eu.mihosoft.vmftext.tests.java24.PackageDeclaration caller;
